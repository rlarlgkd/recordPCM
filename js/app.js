...
//   var leftChannelData = buffers[0];

//   // Display the length of the PCM data
//   console.log("Length of PCM data: " + leftChannelData.length);

//   // You can also visualize this length in your UI, for example:
//   document.getElementById("pcmDataLength").innerText =
//     "Length of PCM data: " + leftChannelData.length;
// }
